(function () {
  ...
  function inject() {
    ...
    addLink(menu, "/plugins/platform-plus/pricing", "Pricing");
    addLink(menu, "/plugins/platform-plus/subscription", "Subscription");
    addLink(menu, "/plugins/platform-plus/billing", "Billing History");
  }
